...
const CaseStudiesSection = () => {
  ...
  return (
    <section id="case-studies" className="section-seamless section-bg-case-studies min-h-screen flex flex-col justify-center px-6 md:px-12 lg:px-24 py-16" ref={ref}>
